...
export const MAX_ACTIVE_SERVICE_TICKETS = 10;
export const MAX_WAITING_LOBBY_TICKETS = 10;
...
export const ENGINEER_CAPACITY_MESSAGE = "The selected engineer has reached the maximum ticket capacity (10 Active Work + 10 Waiting Lobby tickets). Please assign this ticket to another engineer.";
